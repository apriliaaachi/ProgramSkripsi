 ...
 * @author Asus
 */
public class StemmingNaziefAdriani {
    ...
    private String derivationPrefiksA(String akarKata) {
        ...
        if (((tipe1) || (tipe2) || (tipe3) || (tipe4) || (tipe5)) == false) {
            ...
            try {
                ...
                Logger.getLogger(StemmingNaziefAdriani.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    private String derivationPrefiksB(String akarKata) throws IOException {
        ...
        if ((akarKata.startsWith("di") || akarKata.startsWith("ke") || akarKata.startsWith("se"))
            ...
            if (akarKata.startsWith("be")) {
                ...
                if (akarKata.startsWith("me")
                        && (akarKata.charAt(2) == 'l' || akarKata.charAt(2) == 'r' || akarKata.charAt(2) == 'w' || akarKata.charAt(2) == 'y')
                        && vowel(akarKata.charAt(3)) == true) {
                    akarKata = akarKata.substring(2, akarKata.length());

                } else if (akarKata.length() > 3) {
                     
                    if (akarKata.startsWith("mem")
                            && (akarKata.charAt(3) == 'b' || akarKata.charAt(3) == 'f' || akarKata.charAt(3) == 'v')) {
                        akarKata = akarKata.substring(3, akarKata.length());
                        
                    } else if (akarKata.startsWith("mem")
                            && ((akarKata.charAt(3) == 'r'  && vowel(akarKata.charAt(4)) == true) || vowel(akarKata.charAt(3)) == true)) {
                        String kata_asli = akarKata;
                    ...
                    } else if (akarKata.startsWith("men")
                            && (akarKata.charAt(3) == 'c' || akarKata.charAt(3) == 'd' || akarKata.charAt(3) == 'j' || akarKata.charAt(3) == 'z')) {
                        akarKata = akarKata.substring(3, akarKata.length());
                        ...
                        if (akarKata.startsWith("meng")
                                && (akarKata.charAt(4) == 'g' || akarKata.charAt(4) == 'h' || akarKata.charAt(4) == 'q')) {
                            akarKata = akarKata.substring(4, akarKata.length());
                            
                        } else if (akarKata.startsWith("meng")
                                && vowel(akarKata.charAt(4))) {
                            String kata_asli = akarKata;
                        ...
                        } else if (akarKata.startsWith("meny")
                                && vowel(akarKata.charAt(4))) {
                            ...
                            if (akarKata.startsWith("memp") && vowel(akarKata.charAt(4)) && akarKata.charAt(4) != 'e') {
                                ...
                                if (akarKata.startsWith("mempe")
                                        && (akarKata.charAt(5) == 'r' || akarKata.charAt(5) == 'l')) {
            ...
            if (akarKata.startsWith("pe")) {
                if (akarKata.length() > 3) {
                    if (akarKata.startsWith("pe")
                            && (akarKata.charAt(2) == 'w' || akarKata.charAt(2) == 'y')
                            && vowel(akarKata.charAt(3))) {
                        akarKata = akarKata.substring(2, akarKata.length());
                    } else if (akarKata.startsWith("per")
                            && vowel(akarKata.charAt(3))) {
                        String kata_asli = akarKata;
                        akarKata = akarKata.substring(3, akarKata.length());
                        if (!kata_dasar(akarKata)) {
                    ...
                    } else if (akarKata.startsWith("pem")
                            && (akarKata.charAt(3) == 'b' ||akarKata.charAt(3) == 'f' || akarKata.charAt(3) == 'v')) {

                        akarKata = akarKata.substring(3, akarKata.length());

                    } else if (akarKata.startsWith("pem")
                            && ((akarKata.charAt(3) == 'r' && vowel(akarKata.charAt(4))) || vowel(akarKata.charAt(3)))) {
                        String kata_asli = akarKata;
                        akarKata = akarKata.substring(2, akarKata.length());
                        if (!kata_dasar(akarKata)) {
                            akarKata = 'p' + kata_asli.substring(2, kata_asli.length());
                        }
                    } else if (akarKata.startsWith("pen")
                            && (akarKata.charAt(3) == 'c' || akarKata.charAt(3) == 'd' || akarKata.charAt(3) == 'j' || akarKata.charAt(3) == 'z')) {
                    ...
                    } else if (akarKata.startsWith("pel")
                            && vowel(akarKata.charAt(3))
                            && akarKata != "pelajar") {
                    ...
                    } else if (akarKata.startsWith("peng")
                                && vowel(akarKata.charAt(4))) {
                            String kata_asli = akarKata;
                            akarKata = akarKata.substring(4, akarKata.length());
                            if (!kata_dasar(akarKata)) {
                        ...
                        } else if (akarKata.startsWith("peny")
                                && vowel(akarKata.charAt(4))) {
